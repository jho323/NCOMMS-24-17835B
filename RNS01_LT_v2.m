...
% ipsilateral leads: 1 2 4 5 6 9 10 11 14
eegToPlot= [1:14];
count2 = 0;
count3 = 0;
...
%                     end
                ...
                elseif plotStyle ==3
                    ...
                    sgtitle(['MER 36 LT ' windowLabs{aa}])
                    hold off
        ...
        if ismember(depthLab,stimDepth)
            ...
            for ii = 1:size(firingDat,1)
                ...
                findpeakVals= [spikeProm 5*spikeThres 50
                               ...
                               spikeProm*2 6*spikeThres 50];

                if ismember(count, [6 8 12 14 15 17])
                    param = 2;
                elseif ismember(count, [17 25 21 ])
                    param = 3;
